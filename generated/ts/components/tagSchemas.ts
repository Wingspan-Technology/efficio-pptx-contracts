...
export const tagSchemas = {
  ...
  "table": {
    ...
    "example": {
      ...
      "efficio_table_config": "{\"cells\":[{\"row\":0,\"col\":0,\"render_action\":\"preserve\"},{\"row\":1,\"col\":0,\"render_action\":\"render\",\"text_format\":\"bullets\",\"min_items\":1,\"max_items\":3,\"max_chars_per_item\":40}]}",
