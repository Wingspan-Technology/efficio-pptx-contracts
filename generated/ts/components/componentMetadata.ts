  ...
  "categorical_fill": {
    ...
    "tags": {
      ...
      "efficio_classification_scheme_id": {
        ...
        "description": "References one scheme_id from the presentation-level efficio_classification_schemes registry.",
        "ui": {
          "order": 50
        }
      }
  ...
  "text": {
    ...
    "tags": {
      ...
      "efficio_sizing_mode": {
        ...
        "description": "Whether the shared text-capacity values are estimated automatically or set manually.",
        "ui": {
          "order": 60
        }
      },
